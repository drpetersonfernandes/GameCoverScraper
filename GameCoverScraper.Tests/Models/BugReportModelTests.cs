...
namespace GameCoverScraper.Tests.Models;

public class BugReportModelTests
{
    [Fact]
    public void DefaultApplicationNameShouldBeGameCoverScraper()
    {
        var model = new BugReportModel();

        model.ApplicationName.Should().Be("GameCoverScraper");
    }
    ...
    public void ToStringShouldContainEnvironmentDetailsSection()
    {
        ...
        result.Should().Contain("Application Name: GameCoverScraper");
    }
