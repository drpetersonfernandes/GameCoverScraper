...
public class SettingsManagerEdgeCaseTests : IDisposable
{
    ...
    [Fact]
    public void LoadSettingsWithCorruptedXmlShouldRevertToDefaults()
    {
        // Write corrupted XML to the settings file
        File.WriteAllText(_originalSettingsPath, "this is not valid xml at all !!!");
    ...
    [Fact]
    public void LoadSettingsWithEmptyXmlShouldRevertToDefaults()
    {
    ...
    [Fact]
    public void LoadSettingsWithPartialXmlShouldFillMissingWithDefaults()
    {
        const string partialXml = """
                                  <?xml version="1.0" encoding="utf-8"?>
                                  <Settings>
                                      <ThumbnailSize>500</ThumbnailSize>
                                      <SearchEngine>Google</SearchEngine>
                                  </Settings>
                                  """;
        File.WriteAllText(_originalSettingsPath, partialXml);
